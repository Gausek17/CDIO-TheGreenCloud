let VistaMenu = {
        ...
        this.navAdmin.innerHTML = ` 
            <ul>
                ...
                <li class="navNoticias">
                  <a href="graficasAdmin.html" class="itemNav"><img src="../imagenes/menu/sensor.png" alt="Imagen Sensor" class="iconNoticias"><span class="textNav">Noticias</span></a>
                </li>
            </ul>`;
    },
    sideNav: {},
    ...
    crearSideNav: function () {
        this.sideNav.innerHTML = `<div class="headerMenu"><span class="menuTextAdmin">User Panel</span><a href="javascript:void(0)" class="closebtn" onclick="closeNav()">&times;</a></div>
            ...
            <a id="a4" href="#" class="itemMenu"><img src="../imagenes/menu/sensor.png" alt="Imagen Noticias" class="iconNoticias"><span class="menuText">Noticias</span></a>`;
    }
};
